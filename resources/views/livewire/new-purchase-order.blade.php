                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions w-50">
                                <select class="form-select bg-blue-lt" wire:model.live="selectedVendor"
                                    wire:change="getSelectedVendor">
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-bordered table-nowrap card-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Code</td>
                                        <td class="text-center">{{ $vendorCode }}</td>
                                    </tr>
                                    <tr>
                                        <td>Name</td>
                                    ...
                                    <tr class="bg-light">
                                        <th colspan="2" class="subheader">Location</th>
                                    <tr>
                                        <td>City</td>
                                        <td class="text-center">{{ $vendorCity }}</td>
                                    </tr>
                                    <tr>
                                        <td>Address</td>
                                        <td class="text-center">{{ $vendorAddress }}</td>
                                    </tr>
                                    <tr class="bg-light">
                                        <th colspan="2" class="subheader">Contact</th>
                                    <tr>
                                        <td>Cellphone No.</td>
                                        <td class="text-center">{{ $vendorContact }}</td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td class="text-center">{{ $vendorEmail }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
