    ...
    <div class="container container-tight py-4">
        ...
        <div class="card card-md">
            ...
            <div class="card-header p-5">
                <h1 class="card-title h2 fw-bolder text-red">You are about to delete a
                    {{ str_replace('ie', 'y', substr(ucwords($key), 0, -1)) }}!
                </h1>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route($key . '.destroy', $subcategory->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('DELETE')
                    ...
                    <ul class="list-unstyled space-y">
                        <li class="row g-2">
                            ...
                            <span class="col">
                                <strong class="d-block">{{ $subcategory->code }}</strong>
                        ...
                        <li class="row g-2">
                            ...
                            <span class="col">
                                <strong class="d-block">{{ $subcategory->name }}</strong>
                        ...
                        <li class="row g-2">
                            ...
                            <span class="col">
                                <strong class="d-block">{{ $subcategory->created_by }}</strong>
