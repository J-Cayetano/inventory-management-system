...
@section('contents')
    <div class="container container-tight py-4">
        ...
        <div class="card card-md">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route($key . '.destroy', $brand->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('DELETE')
                    ...
                    <ul class="list-unstyled space-y">
                        <li class="row g-2">
                            ...
                            <span class="col">
                                <strong class="d-block">{{ $brand->code }}</strong>
                        ...
                        <li class="row g-2">
                            ...
                            <span class="col">
                                <strong class="d-block">{{ $brand->created_by }}</strong>
