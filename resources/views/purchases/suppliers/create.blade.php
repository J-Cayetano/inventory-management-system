        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">Create a Supplier</h3>
                </div>
                {{-- Body --}}
                <div class="card-body">
                            ...
                            <div class="col-sm-4 p-5">
                                <div class="form-group">
                                    ...
                                    <input class="form-control word-case {{ $errors->has('city') ? 'is-invalid' : '' }}"
                                        type="text" name="city" id="city" value="{{ old('city', '') }}" required>
                                    @error('city')
                            ...
                            <div class="col-sm-4 p-5">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}"
                                        type="email" name="email" placeholder="supplier@email.com" id="email"
